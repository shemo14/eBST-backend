        ...
        <div class="col-sm-12">
            <div class="card-box card-tabs">
                <ul class="nav nav-pills pull-right">
                    ...
                    <li class="">
                        <a href="#about" data-toggle="tab" aria-expanded="false">عن الموقع</a>
                    </li>
                    <li class="">
                        <a href="#messages" data-toggle="tab" aria-expanded="true">الرسائل والايميل</a>
                    </li>
                    {{--<li class="">--}}
                        {{--<a href="#email" data-toggle="tab" aria-expanded="true">قالب الايميل</a>--}}
                    {{--</li>--}}
                    <li class="">
                        <a href="#notify" data-toggle="tab" aria-expanded="false">الاشعارات</a>
                    </li>
                    {{--<li class="">--}}
                        {{--<a href="#api" data-toggle="tab" aria-expanded="false">API</a>--}}
                    {{--</li>--}}
                </ul>
                                ...
                                <div class="panel panel-custom panel-border">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" enctype="multipart/form-data" action="">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">وصف الموقع</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">الكلمات الدلاليه</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">حقوق الشركه</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5">حفظ</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="panel panel-custom panel-border">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">عن الموقع</h3>
                                        </div>
                                        <div class="panel-body text-center">
                                            <form class="form-horizontal" method="post" role="form" action="{{route('about')}}">
                                                {{csrf_field()}}
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <textarea type="text" rows="14" name="about_us" class="form-control">{{$setting->about_us}}</textarea>
                                                    </div>
                                                </div>
                                                <button type="submit" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5">حفظ</button>
                                            </form>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{route('update-smtp')}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_type}}" id="example-email" name="smtp_type" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">اسم المستخدم</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_username}}" id="example-email" name="smtp_username" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">الرقم السري</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_password}}" id="example-email" name="smtp_password" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">الاسم المرسل</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_sender_email}}" id="example-email" name="smtp_sender_email" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">الايميل المرسل</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_sender_name}}" id="example-email" name="smtp_sender_name" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">البورت</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_port}}" id="example-email" name="smtp_port" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">الهوست</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_host}}" id="example-email" name="smtp_host" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">التشفير</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->smtp_encryption}}" id="example-email" name="smtp_encryption" class="form-control">
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5">حفظ</button>
                                        </form>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="{{route('update-sms')}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->sms_number}}" id="example-email" name="sms_number" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">الرقم السري</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->sms_password}}" id="example-email" name="sms_password" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">اسم الراسل</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->sms_sender_name}}" id="example-email" name="sms_sender_name" class="form-control">
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5">حفظ</button>
                                        </form>
                    ...
                    {{--<div id="email" class="tab-pane fade">--}}
                        {{--<div class="row">--}}
                            {{--<div class="col-md-12">--}}
                                {{--<div class="panel panel-custom panel-border">--}}
                                    {{--<div class="panel-heading">--}}
                                        {{--<h3 class="panel-title">قالب الايميل</h3>--}}
                                    {{--</div>--}}
                                    {{--<div class="panel-body text-center">--}}
                                        {{--<form class="form-horizontal" role="form" enctype="multipart/form-data" action="">--}}
                                            {{--<div class="form-group">--}}
                                                {{--<label class="col-md-4" for="example-email">اسم الموقع</label>--}}
                                                {{--<div class="col-md-8">--}}
                                    ...
                                    <div class="panel-body text-center">
                                        <form class="form-horizontal" role="form" method="post" action="{{route('update-one-signal')}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->oneSignal_application_id}}" name="oneSignal_application_id" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2" for="example-email">Authorization</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->oneSignal_authorization}}" name="oneSignal_authorization" class="form-control">
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5">حفظ</button>
                                        </form>
                                    ...
                                    <div class="panel-body text-center">
                                        <form class="form-horizontal" role="form" method="post" action="{{route('update-fcm')}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->fcm_server_key}}" name="fcm_server_key" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2" for="example-email">FCM Sender ID</label>
                                                <div class="col-md-10">
                                                    <input type="text" value="{{$contacts->fcm_sender_id}}" name="fcm_sender_id" class="form-control">
                                                </div>
                                            </div>
                                            <button type="submit"  class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5">حفظ</button>
                                        </form>
                                ...
                                {{--<div class="col-md-12">--}}
                                    {{--<div class="panel panel-custom panel-border">--}}
                                        ...
                                        {{--<div class="panel-body text-center">--}}
                                            {{--<form class="form-horizontal" role="form" enctype="multipart/form-data" action="">--}}
                                                {{--<div class="form-group">--}}
                                                    {{--<label class="col-md-2" for="example-email">Google Analytics</label>--}}
                                                    {{--<div class="col-md-10">--}}
                                                        {{--<textarea type="text" rows="14" class="form-control"></textarea>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                {{--<div class="form-group">--}}
                                                    {{--<label class="col-md-2" for="example-email">Live Chat</label>--}}
                                                    {{--<div class="col-md-10">--}}
                                                        {{--<textarea type="text" rows="14" class="form-control"></textarea>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
