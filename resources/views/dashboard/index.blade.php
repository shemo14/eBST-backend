    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <a href="{{url('admin/')}}" style="font-family: JF-Flat;" class="logo"><img class="site-logo" src="{{appPath()}}/images/site/logo.png" width="100%"><i style="color: #fff !important;" class="fa fa-home"></i></a>
            </div>
